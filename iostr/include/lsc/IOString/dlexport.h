...
#   ifdef IOSTR_DLL_EXPORT
#       define IOSTR_LIB __declspec(dllexport)
#   else
#       define IOSTR_LIB __declspec(dllimport)
#   endif
#else
#   define IOSTR_LIB   __attribute__ ((visibility ("default"))) // Not ms-Windows/MSVC
#endif
