...
bool String::SkipWS(std::basic_string<char, std::char_traits<char>, std::allocator<char>>::iterator &pos)
{
    return false;
}
...
std::size_t String::Words(String::List &Collection, const string &Delimiters, bool KeepAsWord) const
{
    return 0;
}
...
int String::PushWord(String::List &strm, String::Word &w, std::string::size_type sz)
{
    return 0;
}
